...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>Sobre nós | Alt Solutions</title>
	...
	<body>
		...
		<main>
			<section id="sessao-sobre">
				<div class="sessao-sobre-content">
					<h1>Quem somos</h1>
			...
			<section id="sessao-sobre2">
				<div class="sessao-sobre-content2">
					<h2>Serviços</h2>
					<div class="sessao-minibanner2"></div>
					<div class="sessao-descricao2">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						...
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						<a href="contato.php" class="sessao-sobre-btn">Entre em contato</a>
					</div>
				</div>
			</section>
		</main>
